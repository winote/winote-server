...
export class NestApplicationContextProvider {
    ...
    private static instance: NestApplicationContextProvider = new NestApplicationContextProvider();
    ...
    public static getInstance(): NestApplicationContextProvider {
        if (!NestApplicationContextProvider.instance) {
            NestApplicationContextProvider.instance = new NestApplicationContextProvider();
        }
